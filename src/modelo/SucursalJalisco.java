...
/**
 * Clase que representa la sucursal de MonosChinos MX ubicada en Jalisco. Implementa {@code Sucursal}.
 * Al invocar realizarPedido(), se crea la vista y controlador asociados y se inicia el flujo de compra.
 */
public class SucursalJalisco implements Sucursal {

    /**
     * Inicia el proceso de compra al cliente desde la sucursal Jalisco.
