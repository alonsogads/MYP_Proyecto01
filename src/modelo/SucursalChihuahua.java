...
/**
 * Clase que representa la sucursal de MonosChinos MX ubicada en Chihuahua. Implementa {@code Sucursal}.
 * Al invocar realizarPedido(), se crea la vista y controlador asociados y se inicia el flujo de compra.
 */
public class SucursalChihuahua implements Sucursal {

    /**
     * Inicia el proceso de compra al cliente desde la sucursal Chihuahua.
